<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="${comment}" prop="workerId">
        <el-input
    ...
    <el-table v-loading="loading" :data="monthList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="${comment}" align="center" prop="workerId" />
      <el-table-column label="月份" align="center" prop="month" />
      <el-table-column label="工时" align="center" prop="hours" />
      <el-table-column label="当月人工" align="center" prop="price" />
      <el-table-column label="预支" align="center" prop="advance" />
      <el-table-column label="余额" align="center" prop="rest" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="${comment}" prop="workerId">
          <el-input v-model="form.workerId" placeholder="请输入${comment}" />
        </el-form-item>
        <el-form-item label="月份" prop="month">
...
<script>
import { listMonth, getMonth, delMonth, addMonth, updateMonth } from "@/api/workers/month";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除工人工时按月划分编号为"' + ids + '"的数据项？').then(function() {
        return delMonth(ids);
      }).then(() => {
        this.getList();
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('workers/month/export', {
        ...this.queryParams
